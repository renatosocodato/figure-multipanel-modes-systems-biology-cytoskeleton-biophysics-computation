"""ATHENA FCT grant — project summary figure (stub). A4 portrait."""
...
def build_figure():  # pragma: no cover
    ...
    fig, axes = figure_with_grid(
        ...
        suptitle="ATHENA project", subtitle="aims summary",
        theme="fct_grant",
    )
    _ = axes, inputs
    return fig
...
def main() -> None:  # pragma: no cover
    fig = build_figure()
    try:
        export_figure(fig, stem="athena_fct_summary",
                      theme="fct_grant", palette="mechanism_class",
